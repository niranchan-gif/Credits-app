...
class BorrowerPdfService {
  // Reduced logical width to make everything appear much larger and readable on mobile screens
  static const double _pageWidth = 800;
  static const double _pageHeight = 1131; // 800 * 1.414 (A4 ratio)
  
  // Adjusted for larger text
  static const int _paymentsPerPageFirst = 12;
  static const int _paymentsPerPageNext = 18;
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            Expanded(
              child: Padding(
                padding: const EdgeInsets.symmetric(horizontal: 30, vertical: 25), // Reduced horizontal padding for mobile view
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        const Text(
                          'STATEMENT',
                          style: TextStyle(color: _brand, fontSize: 26, fontWeight: FontWeight.bold, letterSpacing: 1.2),
                        ),
                        Text(
                          'தேதி: $todayStr',
                          style: const TextStyle(color: Color(0xFF475569), fontSize: 20, fontWeight: FontWeight.bold),
                        ),
                      ],
                    ),
      ...
      child: Column(
        ...
        children: [
          Text(
            ...
            style: const TextStyle(color: _brand, fontSize: 26, fontWeight: FontWeight.bold),
          ),
              ...
              Expanded(
                child: Container(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      const Text('செலுத்தியது', style: TextStyle(color: Color(0xFF166534), fontSize: 16, fontWeight: FontWeight.w600)),
                      const SizedBox(height: 4),
                      Text(
                        '₹${totalPaid.toStringAsFixed(0)}',
                        style: const TextStyle(color: Color(0xFF166534), fontSize: 26, fontWeight: FontWeight.bold),
                      ),
                    ],
                  ),
                ),
              ...
              Expanded(
                child: Container(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      const Text('நிலுவை', style: TextStyle(color: Color(0xFF991B1B), fontSize: 16, fontWeight: FontWeight.w600)),
                      const SizedBox(height: 4),
                      Text(
                        '₹${balanceToPay.toStringAsFixed(0)}',
                        style: const TextStyle(color: Color(0xFF991B1B), fontSize: 26, fontWeight: FontWeight.bold),
                      ),
                    ],
                  ),
                ),
